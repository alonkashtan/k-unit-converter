...
class Distance : UnitCategory<Distance.DistanceUnits>() {
    ...
    @Name("toMeters")
    public fun toMeters(value: Double, unit: DistanceUnits): Double { return unitToMain(value, unit) }
    @Name("fromMeters")
    public fun fromMeters(meters: Double, unit: DistanceUnits): Double = mainToUnit(meters, unit)
}